...
::-webkit-scrollbar-thumb:window-inactive {
  background: rgba(255, 255, 255, 0.3);
	...
	<link rel="stylesheet" id="e-animation-fadeIn-css" href="{{ asset('assets/css/fadeIn.min.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="e-animation-fadeInLeft-css" href="{{ asset('assets/css/fadeInLeft.min.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="e-animation-fadeInRight-css" href="{{ asset('assets/css/fadeInRight.min.css')}}" type="text/css"
		media="all">
	<link rel="stylesheet" id="widget-spacer-css" href="{{ asset('assets/css/widget-spacer.min.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="e-animation-fadeInUp-css" href="{{ asset('assets/css/fadeInUp.min.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="widget-image-css" href="{{ asset('assets/css/widget-image.min.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="widget-icon-list-css" href="{{ asset('assets/css/custom-widget-icon-list.min_1.css')}}" type="text/css"
		media="all">
	<link rel="stylesheet" id="elementor-post-23-css" href="{{ asset('assets/css/post-23.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-119-css" href="{{ asset('assets/css/post-119.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="site-breadcrumb-css" href="{{ asset('assets/css/breadcrumb.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="wdt-blog-css" href="{{ asset('assets/css/blog.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="dermis-breadcrumb-css" href="{{ asset('assets/css/breadcrumb_1.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="dermis-plus-blog-css" href="{{ asset('assets/css/blog_1.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="dermis-pro-advance-field-css" href="{{ asset('assets/css/style_13.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="dermis-pro-blog-css" href="{{ asset('assets/css/blog_2.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="dermis-pro-auth-css" href="{{ asset('assets/css/style_1.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="wdt-ultimate-booking-layout-ad-css" href="{{ asset('assets/css/layout-ad.css')}}" type="text/css"
		media="all">
...
<body
																		...
																		<div id="dermis-7c9af44"
																			class="wdt-logo-container"> <a href=" /"
																				rel="home"><img src="/assets/images/lbg_logo.png"
																					alt="Dermis Site1" class="CustomColor"></a></div>
																	</div>
																</div>
																			...
																			<div class="wdt-popup-box-content-inner">
																				<style>
																					...
																					.elementor-345 .elementor-element.elementor-element-dc8abbe>.elementor-widget-wrap>.elementor-motion-effects-container>.elementor-motion-effects-layer {
																						background-image: url("assets/images/newletter-img.jpg");
																						background-position: center center;
																						background-repeat: no-repeat;
																						background-size: cover;
																					}
																													...
																													<div class="elementor-element elementor-element-f97f2cb elementor-widget elementor-widget-image"
																														...
																														<div
																															...
																															<img loading="lazy"
																																width="1000"
																																height="1000"
																																src="assets/images/newletter-img.jpg"
																																class="attachment-full size-full wp-image-1390"
																																alt="newletter-img"
																																srcset="assets/images/newletter-img.jpg 1000w, assets/images/newletter-img-300x300.jpg 300w, assets/images/newletter-img-150x150.jpg 150w, assets/images/newletter-img-768x768.jpg 768w, assets/images/newletter-img-205x205.jpg 205w, assets/images/newletter-img-650x650.jpg 650w, assets/images/newletter-img-60x60.jpg 60w, assets/images/newletter-img-100x100.jpg 100w"
																							...
																							<div class="menu-container">
																								<ul id="menu-de-main-menu-2"
																									...
																									<li
																										...
																										<a
																											href="{{ route('services') }}"><span>Services</span></a>
																										<!-- <ul
																											class="sub-menu is-hidden">
																											<li
																												class="close-nav">
																													...
																													<h2
																														...
																														<span
																															...
																															class="elementor-repeater-item-50fc287"><img
																																src="assets/images/home-slider-4-1.jpg"></span><span
																															...
																															class="elementor-repeater-item-669f6be"><img
																																src="assets/images/home-slider-5-1.jpg"></span><span
																										...
																										<div class="elementor-element elementor-element-5a3f368 elementor-widget__width-initial elementor-widget elementor-widget-wdt-heading"
																											...
																											<div
																												...
																												<div class="wdt-heading-holder "
																													...
																													<div
																														class="wdt-heading-content-wrapper">
																														Your confidence and well-being are our top priorities, and we strive to deliver expert care in every step of your journey with us.
																													</div>
																												</div>
																											</div>
																										</div>
									...
									<div class="elementor-widget-wrap elementor-element-populated custompadding">
										...
										<section
											...
											<div class="elementor-container elementor-column-gap-default">
												...
												<div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-2bbb62c customCardwidthright" id="enquiryForm">
													<div class="elementor-widget-wrap elementor-element-populated">
																...
																<div class="elementor-shortcode">
																	<div class="wpcf7">
																		...
																		{{-- <form action="/home-2/#wpcf7-f398-p119-o2"
                                                                            ...
                                                                            {!! Form::open(['url'=> route('storeEnquiry'),'method'=>'POST','class'=>'wpcf7-form init appointment-booking-tab column-2'])!!}
																			...
																			<p>
																				<label><span>Your
                                                                                        ...
                                                                                        {{-- <input
                                                                                            ...
                                                                                            {!! Form::text('email', null, ['class'=>'wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email','required' , 'placeholder' => 'Email']) !!}
                                                                                        </span><i
																				...
																				<label><span>Location
                                                                                        ...
                                                                                        {{-- <input
                                                                                            ...
                                                                                            {!! Form::text('location', null, ['class'=>'wpcf7-form-control wpcf7-text wpcf7-validates-as-required walcf7-datetimepicker','required', 'placeholder' => 'Location']) !!}


                                                                                        </span><i
																						class="wdticon-location-arrow"></i></label>
																				...
																				<label><span>Appointment
                                                                                        ...
                                                                                        {{-- <input
                                                                                            ...
                                                                                            {!! Form::date('date', null, ['class'=>'customDatePaddding wpcf7-form-control wpcf7-text wpcf7-validates-as-required walcf7-datetimepicker','required']) !!}
																				...
																				<label><span>Name
                                                                                        ...
                                                                                        {{-- <input
                                                                                            ...
                                                                                            {!! Form::text('name', null, ['class'=>'wpcf7-form-control wpcf7-text wpcf7-validates-as-required walcf7-datetimepicker','required' , 'placeholder'=> 'Enter Your Name']) !!}
                                                                                        </span><i
																						class="wdticon-user-o"></i></label>
																			</p>
														...
														<div class="elementor-element elementor-element-05ac9a1 wdt-common-heading animated-fast elementor-invisible elementor-widget elementor-widget-wdt-heading"
															...
															<div class="elementor-widget-container">
																<div class="wdt-heading-holder "
																	...
																	<div class="wdt-heading-content-wrapper">Explore our wide range of services and visit our store for best treatments and leading
                                                                        skincare expert
																	</div>
																</div>
															</div>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        ...
                                                                                                        class="dt-sc-service-price">{{ '$ ' .$service->price }}</span>
                                                                                                </div>
                                                                                                <div
														...
														<div class="elementor-element elementor-element-b0a1ecb wdt-common-heading wdt-dark-bg elementor-widget-tablet__width-initial elementor-widget-mobile_extra__width-inherit elementor-widget-mobile__width-inherit animated-fast elementor-invisible elementor-widget elementor-widget-wdt-heading"
															...
															<div class="elementor-widget-container">
																<div class="wdt-heading-holder "
																	...
																	<div class="wdt-heading-content-wrapper"> Connect with our skincare expert to discuss your skin concerns and receive personalized guidance for achieving your healthiest, most radiant skin.</div>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="elementor-element elementor-element-8b77b57 wdt-common-heading animated-fast elementor-invisible elementor-widget elementor-widget-wdt-heading"
															...
															<div class="elementor-widget-container">
																<div class="wdt-heading-holder "
																	...
																	<h2
																		class="wdt-heading-title-wrapper wdt-heading-align- wdt-heading-deco-wrapper">
																		<span class="wdt-heading-title">Discover Laser Hair Removal Options</span>
																	</h2>
																	<div class="wdt-heading-content-wrapper">Say goodbye to unwanted hair with our advanced laser hair removal treatments! Experience smooth, hair-free skin with safe, effective, and long-lasting results tailored to your needs.</div>
																</div>
															</div>
														</div>
													</div>
                                                        ...
                                                        @foreach($laserHairRemovalOptions as $laserHairRemovalOption)
                                                            <div class="wdt-column">
                                                                <div class="wdt-content-item">
                                                                    <div class="wdt-content-media-group">
                                                                        <div class="wdt-content-image-wrapper ">
                                                                            <div class="wdt-content-image"><a href="#"><img
                                                                                        ...
                                                                                        src="{{ asset('uploads/services/'.$laserHairRemovalOption->image) }}"
                                                                    ...
                                                                    <div class="wdt-content-detail-group">
                                                                        <div class="wdt-content-title">
                                                                            <h5><a href="javascript:void(0)">{{ $laserHairRemovalOption->name }}</a></h5>
                                                                        </div>
                                                                        <div class="wdt-content-button wdt-button-clone"><a
                                                                                href="javascript:void(0)">
                                                                                <div class="wdt-button-text"><span>{{ '$ ' .$laserHairRemovalOption->price }}</span></div>
                                                                            </a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
														...
														<div class="elementor-element elementor-element-b474d66 wdt-common-heading animated-fast elementor-invisible elementor-widget elementor-widget-wdt-heading"
															...
															<div class="elementor-widget-container">
																<div class="wdt-heading-holder "
																	...
																	<div class="wdt-heading-content-wrapper">See the incredible transformations our treatments can achieve! Our before-and-after gallery highlights real results from our satisfied clients, showcasing the effectiveness of our skincare expert services.</div>
																</div>
															</div>
														</div>
													</div>
																											...
																											<div
																												...
																												<div class="wdt-before-after-slider-container"
																													...
																													<div
																														...
																														<img decoding="async"
																															src="assets/images/home-one-1-before-image.jpg"><span
																															class="wdt-before-after-slider-span-after">Before</span>
																													</div>
																													<div class="wdt-img wdt-foreground-img"
																														style="clip-path: inset(0 0 0 50%);">
																														<img decoding="async"
																															src="assets/images/home-one-1-after-image.jpg"><span
																											...
																											<div
																												...
																												<div class="wdt-before-after-slider-container"
																													...
																													<div
																														class="wdt-img wdt-background-img">
																														<img decoding="async"
																															src="assets/images/home-one-2-before-image.jpg"><span
																															class="wdt-before-after-slider-span-after">Before</span>
																													</div>
																													<div class="wdt-img wdt-foreground-img"
																														style="clip-path: inset(0 0 0 50%);">
																														<img decoding="async"
																															src="assets/images/home-one-2-after-image.jpg"><span
																															class="wdt-before-after-slider-span-before">After</span>
																													</div>
																													<input
																														type="range"
																											...
																											<div
																												...
																												<div class="wdt-before-after-slider-container"
																													...
																													<div
																														class="wdt-img wdt-background-img">
																														<img decoding="async"
																															src="assets/images/Before-04-img-01.jpg"><span
																															class="wdt-before-after-slider-span-after">Before</span>
																													</div>
																													<div class="wdt-img wdt-foreground-img"
																														style="clip-path: inset(0 0 0 50%);">
																														<img decoding="async"
																															src="assets/images/Before-04-img-02.jpg"><span
																															class="wdt-before-after-slider-span-before">After</span>
																													</div>
																													<input
																														type="range"
																											...
																											<div
																												...
																												<div class="wdt-before-after-slider-container"
																													...
																													<div
																														class="wdt-img wdt-background-img">
																														<img decoding="async"
																															src="assets/images/11befre.jpg"><span
																															class="wdt-before-after-slider-span-after">Before</span>
																													</div>
																													<div class="wdt-img wdt-foreground-img"
																														style="clip-path: inset(0 0 0 50%);">
																														<img decoding="async"
																															src="assets/images/12after.jpg"><span
																															class="wdt-before-after-slider-span-before">After</span>
																													</div>
																													<input
																														type="range"
															...
															<div class="elementor-widget-container">
																<div class="wdt-button-holder wdt-template-textual wdt-button-link wdt-button-style-default wdt-button-size-nm wdt-animation- wdt-button-icon-after"
																	id="wdt-button-a44f7d8"><a class="wdt-button"
																		href="#">
																		<div class="wdt-button-text"><span>Browse all
																				skincare expert Doctors</span></div>
																	</a></div>
															</div>
														</div>
													</div>
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								src="assets/images/doctor-img-4.jpg"
																								class="attachment-full size-full wp-post-image"
																								alt="Dr. Maria Inna"
																								title="Dr. Maria Inna"
																								srcset="assets/images/doctor-img-4.jpg 760w, assets/images/doctor-img-4-260x300.jpg 260w"
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								alt="Dr. Sandu Andrei"
																								title="Dr. Sandu Andrei"
																								srcset="assets/images/doctor-4.jpg 760w, assets/images/doctor-4-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								alt="Dr. Petya Abram"
																								title="Dr. Petya Abram"
																								srcset="assets/images/doctor-5.jpg 760w, assets/images/doctor-5-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								decoding="async"
																								width="760" height="876"
																								src="assets/images/doctor-6.jpg"
																								class="attachment-full size-full wp-post-image"
																								alt="Dr. Yasha Kir"
																								title="Dr. Yasha Kir"
																								srcset="assets/images/doctor-6.jpg 760w, assets/images/doctor-6-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								decoding="async"
																								width="760" height="876"
																								src="assets/images/doctor-img-3.jpg"
																								class="attachment-full size-full wp-post-image"
																								alt="Dr. Aelita Mehrnaz"
																								title="Dr. Aelita Mehrnaz"
																								srcset="assets/images/doctor-img-3.jpg 760w, assets/images/doctor-img-3-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								decoding="async"
																								width="760" height="876"
																								src="assets/images/doctor-img-6.jpg"
																								class="attachment-full size-full wp-post-image"
																								alt="Dr. Lara Cristina"
																								title="Dr. Lara Cristina"
																								srcset="assets/images/doctor-img-6.jpg 760w, assets/images/doctor-img-6-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								decoding="async"
																								width="760" height="876"
																								src="assets/images/Doctor-img-01.jpg"
																								class="attachment-full size-full wp-post-image"
																								alt="Dr. Varya Arezoo"
																								title="Dr. Varya Arezoo"
																								srcset="assets/images/Doctor-img-01.jpg 760w, assets/images/Doctor-img-01-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								decoding="async"
																								width="760" height="876"
																								src="assets/images/doctor-img-5.jpg"
																								class="attachment-full size-full wp-post-image"
																								alt="Dr. Sofia Claire"
																								title="Dr. Sofia Claire"
																								srcset="assets/images/doctor-img-5.jpg 760w, assets/images/doctor-img-5-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								decoding="async"
																								width="760" height="876"
																								src="assets/images/doctor-img-7.jpg"
																								class="attachment-full size-full wp-post-image"
																								alt="Dr. Dina Atousa"
																								title="Dr. Dina Atousa"
																								srcset="assets/images/doctor-img-7.jpg 760w, assets/images/doctor-img-7-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
																			...
																			<div class="dt-sc-staff-item type1"><a
																				...
																				<div class="image"><a
																						...
																						<div class="dt-image-item"><img
																								...
																								decoding="async"
																								width="760" height="876"
																								src="assets/images/doctor-img-2.jpg"
																								class="attachment-full size-full wp-post-image"
																								alt="Dr. Violeta Robab"
																								title="Dr. Violeta Robab"
																								srcset="assets/images/doctor-img-2.jpg 760w, assets/images/doctor-img-2-260x300.jpg 260w"
																								sizes="(max-width: 760px) 100vw, 760px">
																						</div>
																					</a>
																					<div class="dt-sc-staff-overlay"><a
															...
															<div class="swiper-slide custom">
																<div class="wdt-content-item">
																	...
																	<div class="wdt-content-detail-group">
																		...
																		<div class="wdt-content-title-group below">
																			<div class="wdt-content-title">
																				<h5><a href="#">Sreelakshmi Nair</a></h5>
																			</div><span></span>
															...
															<div class="swiper-slide custom">
																<div class="wdt-content-item">
																	...
																	<div class="wdt-content-detail-group">
																		...
																		<div class="wdt-content-title-group below">
																			<div class="wdt-content-title">
																				<h5><a href="#">Reshmamary Thomas</a></h5>
																			</div><span></span>
																			{{-- <div class="wdt-content-subtitle">Fat
																				Reduction</div> --}}
																		</div>
																...
																<div class="wdt-heading-holder "
																	...
																	<h2
																		...
																		<span class="wdt-heading-title">We Specialize In
																			All skincare expert Treatments</span>
																	</h2>
																	<div class="wdt-heading-content-wrapper">We provide expert care in skincare, addressing all your skin concerns with precision and dedication. Our focus is to ensure the best treatment and experience for every individual.</div>
																</div>
															</div>
														</div>
															...
															<div class="elementor-widget-container">
																<ul class="elementor-icon-list-items">
																	...
																	<li class="elementor-icon-list-item">
																		...
																		<span class="elementor-icon-list-text">Advanced skincare technology and techniques</span>
																	</li>
																	<li class="elementor-icon-list-item">
																		<span class="elementor-icon-list-icon">
																			<svg xmlns="http://www.w3.org/2000/svg"
																			...
																			<div class="wdt-column">
																				<div class="wdt-content-item">
																					...
																					<div
																						...
																						<div class="wdt-content-title">
																							<h5><a
																									href="tel:000%20-%20123%20-%20456789">+1 519-852-6001</a>
																							</h5>
																						</div>
																						<div
																							class="wdt-content-subtitle">
																			...
																			<div class="wdt-column">
																				<div class="wdt-content-item">
																					...
																					<div
																						...
																						<div class="wdt-content-title">
																							<h5><a
																									href="laserbygurr@gmail.com" style="    font-size: 16px;">laserbygurr@gmail.com</a>
																							</h5>
																						</div>
																						<div
																							class="wdt-content-subtitle">
													...
													<div class="elementor-column elementor-col-20 elementor-inner-column elementor-element elementor-element-ba9878e"
														...
														<div class="elementor-widget-wrap elementor-element-populated">
															...
															<div class="elementor-element elementor-element-c837458 elementor-widget__width-initial elementor-widget elementor-widget-text-editor"
																...
																data-widget_type="text-editor.default">
																<div class="elementor-widget-container">
																	<p>At our clinic, we are committed to providing exceptional skincare expert treatments tailored to your unique needs.</p>
																</div>
															</div>
																	...
																	<ul
																		...
																		<li
																			...
																			<a href="tel:%20000%20-%20123%20-%20456789">
																				...
																				<span
																					class="elementor-icon-list-text">+1 519-852-6001</span>
																			</a>
																		</li>
																	</ul>
																</div>
	...
	<link rel="stylesheet" id="wdt-elementor-icons-css" href="{{ asset('assets/css/custom-widget-icon-list.min.css')}}" type="text/css"
		media="all">
	...
	<link rel="stylesheet" id="wdt-advanced-slider-css" href="{{ asset('assets/css/style_3.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="jquery.magnific-popup-css" href="{{ asset('assets/css/jquery.magnific-popup_1.css')}}" type="text/css"
		media="all">
	<link rel="stylesheet" id="wdt-popup-box-css" href="{{ asset('assets/css/style_10.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-button-css" href="{{ asset('assets/css/style_9.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-101-css" href="{{ asset('assets/css/post-101.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-345-css" href="{{ asset('assets/css/post-345.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-mailchimp-css" href="{{ asset('assets/css/style_4.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-95-css" href="{{ asset('assets/css/post-95.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-text-image-css" href="{{ asset('assets/css/style_6.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-heading-css" href="{{ asset('assets/css/style_5.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="wdt-counter-css" href="{{ asset('assets/css/style_14.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="elementor-post-785-css" href="{{ asset('assets/css/post-785.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-icon-box-css" href="{{ asset('assets/css/style_12.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="elementor-post-786-css" href="{{ asset('assets/css/post-786.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-testimonial-css" href="{{ asset('assets/css/style_15.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="wdt-advanced-carousel-css" href="{{ asset('assets/css/style.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="wdt-image-box-css" href="{{ asset('assets/css/style_11.css')}}" type="text/css" media="all">
	...
	<link rel="stylesheet" id="jquery.magnific-image-box-popup-css" href="{{ asset('assets/css/jquery.magnific-popup.css')}}"
		type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-167-css" href="{{ asset('assets/css/post-167.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-before-after-slider-css" href="{{ asset('assets/css/style_7.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-765-css" href="{{ asset('assets/css/post-765.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-766-css" href="{{ asset('assets/css/post-766.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-926-css" href="{{ asset('assets/css/post-926.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-156-css" href="{{ asset('assets/css/post-156.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="widget-image-gallery-css" href="{{ asset('assets/css/custom-widget-image-gallery.min.css')}}"
		type="text/css" media="all">
	<link rel="stylesheet" id="elementor-post-226-css" href="{{ asset('assets/css/post-226.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-elementor-sections-css" href="{{ asset('assets/css/style_17.css')}}" type="text/css" media="all">
	<link rel="stylesheet" id="wdt-elementor-widgets-css" href="{{ asset('assets/css/style_16.css')}}" type="text/css" media="all">
	...
	<script type="text/javascript" src="{{ asset('assets/js/script_5.js')}}" id="dermis-pro-auth-js"></script>
	...
	<script type="text/javascript" src="{{ asset('assets/js/jquery.magnific-popup.min_1.js')}}" id="jquery.magnific-popup-js"></script>
	<script type="text/javascript" src="{{ asset('assets/js/script_2.js')}}" id="wdt-popup-box-js"></script>
	...
	<script src="{{ asset('assets/js/fc.js')}}" data-no-optimize="1" data-no-minify="1" data-gt-orig-url="/"
		data-gt-orig-domain="dermis.wpengine.com" data-gt-widget-id="21032342" defer=""></script>
	<script type="text/javascript" src="{{ asset('assets/js/script_1.js')}}" id="wdt-mailchimp-js"></script>
	...
	<script type="text/javascript" src="{{ asset('assets/js/script.js')}}" id="wdt-counter-js"></script>
	...
	<script type="text/javascript" src="{{ asset('assets/js/jquery.magnific-popup.min.js')}}"
	...
	<script type="text/javascript" src="{{ asset('assets/js/script_6.js')}}" id="wdt-before-after-slider-js"></script>
	...
	<script type="text/javascript" src="{{ asset('assets/js/script_3.js')}}" id="wdt-elementor-sections-js"></script>
	...
	<script type="text/javascript" src="{{ asset('assets/js/script_7.js')}}" id="wdt-elementor-widgets-js"></script>
