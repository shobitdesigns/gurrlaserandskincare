...
jQuery(document).ready(function($){
     ...
     */
        ...
        const buttonSummary = [...document.querySelectorAll(".wdt-product-summary")];

        buttonSummary.forEach(item => {
            let buttonCart = item.querySelector(".product-button-cart");
            let buttonBuy_now = item.querySelector(".wc_inline_buttons > .product-buy-now:only-child");

            if(buttonBuy_now) {
                let cartButtonWidth = buttonCart.querySelector(".woocommerce-variation-add-to-cart").clientWidth;
                buttonBuy_now.style.width = `${cartButtonWidth - 10}px`;
        ...
        if(search_val == "" ){
            ...
            jQuery('.quick_search_results').removeClass('active');
                ...
                jQuery.ajax({
                    ...
                    data: {
                        action:'dermis_search_data_fetch',
                        search_val:search_val,
                        ajax_call: true,
                        function_call: 'dermis_search_data_fetch',
